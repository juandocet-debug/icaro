# Migracion inicial acciones (Clean Architecture)
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acciones', to='componentes.componentemodel')),
            ],
            options={
                'db_table': 'actions',
